...
class Cmd:
    ...
    def precmd(self, line) -> Optional[Any]:
    ...
    def postcmd(self, stop: Optional[Any], line) -> Optional[Any]:
    ...
    def onecmd(self, line) -> Optional[Any]:
    ...
    def emptyline(self) -> Optional[Any]:
    ...
    def default(self, line) -> Optional[Any]:
